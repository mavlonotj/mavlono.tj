@extends('layouts.app')
@section('title') Профили {{ Auth::user()->name }} @endsection
@section('content')
    ...
    <div class="p-8 bg-white shadow-md rounded-lg">
        ...
        <div class="flex justify-evenly  mt-12">
            <div class="flex flex-col items-center space-y-3">
                <div class="rounded-xl border-2 p-5 text-lg border-b-4 border-l-4 border-indigo-100">{{ count(Auth::user()->poems) }}</div>
            ...
            <div class="flex flex-col items-center space-y-3">
                <div class="rounded-xl border-2 p-5 text-lg border-b-4 border-l-4 border-indigo-100">{{ count(Auth::user()->views) }}</div>
